**##This package has been forked from https://github.com/pablobarbera and updated with my details, go to https://github.com/pablobarbera/scholarnetwork to get the original version of the package##**
